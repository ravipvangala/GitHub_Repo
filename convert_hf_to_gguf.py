...
class Model:
    ...
    def get_vocab_base_pre(self, tokenizer) -> str:
        ...
        if chkhsh == "347715f544604f9118bb75ed199f68779f423cabb20db6de6f31b908d04d7821":
            ...
            res = "deepseek-coder"
        if chkhsh == "6859af6d4de4cf1fbdc51b6f743ee2602cec2dc22fa5498f2c367e5714a3b4a9":
            # ref: https://huggingface.co/mistralai/Mamba-Codestral-7B-v0.1
            res = "codestral-mamba"    
...
@Model.register("MambaForCausalLM", "MambaLMHeadModel", "FalconMambaForCausalLM", "CodestralMambaForCasualLM")
